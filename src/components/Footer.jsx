...
export default function Footer() {
  return (
    <div className="bg-black text-white min-h-96 w-screen ml-[-35px] mt-8">
      <div className="container-x flex-wrap gap-3 flex justify-between items-baseline text-start pt-[2px]">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-2 items-center">
            <div className="bg-white w-20 h-20 p-0">
              {/* <img src={QrCode} alt="" /> */}
            </div>
